...
- intros a b c; expand; intros w; cbn; firstorder; subst.
  + exists (x ++ x1), x2; repeat split; try done.
    apply app_assoc. exists x, x1; done.
  + exists x1, (x2 ++ x0); repeat split; try done.
    symmetry; apply app_assoc. exists x2, x0; done.
